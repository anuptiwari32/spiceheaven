...
{{--                                <textarea name="description[]" style="display:none" id="hiddenArea"></textarea>--}}
                    ...
                    <div class="mt-4" id="from_part_2">
                        ...
                        <div class="row mt-2">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="input-label" for="exampleFormControlInput1">{{translate('food')}} {{translate('type')}}</label>
                                    <select name="food_type" class="form-control js-select2-custom">
                                        <option value="0">{{translate('veg')}} {{translate('item')}}</option>
                                        <option value="1">{{translate('non-veg')}}</option>
                                    </select>
                                </div>
                            </div>
                        </div>
